...
export const defaultTuneRanges: TuneRangesInput = {
  ...
  notes: 'Generic FH6 tuning ranges. Admin-correctable; override per car when known.',

  tirePressurePsi: { min: 6.5, max: 65.0, step: 0.1 },
  finalDrive: { min: 0.1, max: 7.0, step: 0.01 },
  gearRatio: { min: 0.1, max: 7.0, step: 0.01 },
  camberDeg: { min: -5.0, max: 5.0, step: 0.1 },
  toeDeg: { min: -2.0, max: 2.0, step: 0.1 },
